...
public class InitialRelationLoader {
	...
	public Map<Integer, IntegerPair> perform(PersistenceDMLExecuter dmlExecuter) throws PersistenceException{ 
		Map<Integer, IntegerPair> result = new HashMap<>();
		try {
			Optional<ResultSet> rs = dmlExecuter.selectAllEntriesOfRelationTable(tableName); 
